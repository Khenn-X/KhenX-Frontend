...
export const ROUTES = {
  ...
  ADMIN_NEIGHBOURHOOD_EDIT: (areaName: string) => `/admin/neighbourhoods/${encodeURIComponent(areaName)}/edit`,
  ADMIN_NEIGHBOURHOOD_VIEW: (areaName: string) => `/admin/neighbourhoods/${encodeURIComponent(areaName)}/view`,
