...
const PaymentVerifyPage = lazy(() => import("../pages/public/PaymentVerifyPage"));
  ...
  return (
    ...
    >
      <Routes>
        ...
        />
        <Route
          path="/neighbourhood/match"
          element={
            <PublicLayout>
              <NeighbourhoodMatchPage />
            </PublicLayout>
          }
        />
        <Route
          path="/neighbourhood/compare"
          element={
            <PublicLayout>
              <NeighbourhoodComparePage />
            </PublicLayout>
          }
        />
        <Route
        ...
        <Route
          path="/neighbourhood/:areaName"
          element={
            <PublicLayout>
              <NeighbourhoodDetailPage />
            </PublicLayout>
          }
        />
        ...
        <Route
          ...
          element={
            <AdminRoute>
              <AdminLayout>
                <AdminNeighbourhoodsPage />
              </AdminLayout>
            </AdminRoute>
          }
        />
        <Route
          path="/admin/neighbourhoods/new"
          element={
            <AdminRoute>
              <AdminLayout>
                <AdminNeighbourhoodNewPage />
              </AdminLayout>
            </AdminRoute>
          }
        />
        <Route
          path="/admin/neighbourhoods/:areaName/edit"
          element={
            <AdminRoute>
              <AdminLayout>
                <AdminNeighbourhoodEditPage />
              </AdminLayout>
            </AdminRoute>
          }
        />
        <Route
          path="/admin/neighbourhoods/:areaName/view"
          element={
            <AdminRoute>
              <AdminLayout>
                <AdminNeighbourhoodViewPage />
              </AdminLayout>
            </AdminRoute>
          }
        />
        <Route
          path="/admin/neighbourhoods/import"
          element={
            <AdminRoute>
              <AdminLayout>
                <AdminNeighbourhoodImportPage />
              </AdminLayout>
            </AdminRoute>
          }
        />
