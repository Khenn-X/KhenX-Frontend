...
import { z } from 'zod';
import { MapPin, Shield, Zap, Droplets, Truck, School2, Building2, ShoppingBag, Sparkles, CurrencyNaira } from 'lucide-react';
...
const sectionData = [
  ...
  },
  {
    ...
    icon: Building2,
    fields: [
      { name: 'Building2Count', label: 'Building2 count', type: 'number', min: 0 },
