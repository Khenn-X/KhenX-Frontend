...
const stats = [
  { label: 'Avg. Price Growth (YoY)', value: '+14.2%', fill: 70, color: 'text-[#00C9A7]' },
  { label: 'Avg. Utility Uptime', value: '64%', fill: 64, color: 'text-white' },
  { label: 'Listings Verified', value: '84%', fill: 84, color: 'text-[#00C9A7]' },
  { label: 'High-Confidence Data Coverage', value: '58%', fill: 58, color: 'text-white' },
];

const metrics = [
  { label: 'Power Uptime', value: '92%', icon: Zap, color: 'text-[#00C9A7]' },
  { label: 'Flood Risk', value: 'Medium', icon: Droplets, color: 'text-amber-500' },
  { label: 'Patrol Frequency', value: 'High', icon: ShieldCheck, color: 'text-[#00C9A7]' },
];
...
export default function MarketInsights() {
  return (
    <section className="py-16 bg-[#0A1628]">
      <PageWrapper>
<div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">          {/* Left — heading + stat grid, sits directly on the dark background */}
          <div className="lg:col-span-2">
            <h4 className="text-2xl sm:text-3xl font-bold text-white">Lagos Market Insights</h4>
            <p className="text-sm text-slate-400 mt-3 max-w-md leading-relaxed">
              Real-time data on price appreciation and infrastructure performance across 15+ mainland and island districts.
            </p>
          ...
          <div className="rounded-2xl bg-white p-14 shadow-xl mt-4">
            <div className="flex items-center justify-between mb-5">
              <h5 className="text-base font-bold text-[#0F172A]">Infrastructure Reliability Index</h5>
