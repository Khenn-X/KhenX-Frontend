...
import { FileText, MapPin, BedDouble, Wallet, Sparkles, ImageIcon } from 'lucide-react';
...
const ListingForm = ({
  ...
  const Section = ({
    ...
    <div className="rounded-2xl border border-slate-200/80 bg-white p-6 transition-shadow duration-200 hover:shadow-sm hover:shadow-slate-200/60">
  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-5">
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full rounded-xl bg-[#0A1628] py-3 text-sm font-semibold text-white shadow-sm shadow-[#0A1628]/20 hover:bg-[#0A1628]/90 hover:-translate-y-0.5 disabled:opacity-60 disabled:translate-y-0 disabled:cursor-not-allowed transition-all"
      >
