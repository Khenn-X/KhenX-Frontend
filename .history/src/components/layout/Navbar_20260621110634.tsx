...
import {
  ...
  ChevronDown, Home, Building2, ShieldCheck, FileText,
  Users, BarChart3, AlertTriangle, ClipboardList, Zap, Navigation, BookOpen, TrendingUp, Map, Newspaper,
  Scale, Clock, BadgeCheck, Star, PlusCircle,
} from 'lucide-react';
