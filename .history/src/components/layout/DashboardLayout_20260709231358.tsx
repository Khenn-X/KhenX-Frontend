  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFC]">
      ...
      <main className={cn('flex-1 transition-all duration-300 ease-in-out', isSidebarOpen ? 'ml-60' : 'ml-16')}>
        ...
        <div className="sticky top-0 z-30 flex h-16 items-center mb-4 justify-end px-6 bg-[#F8FAFC]/90 backdrop-blur-sm border-b border-slate-200/80 shadow-sm shadow-slate-200/50">
          {user && (
