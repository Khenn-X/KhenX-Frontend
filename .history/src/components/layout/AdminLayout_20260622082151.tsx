...
import {
  ...
  AlertTriangle, Users, LogOut, MapPin, Menu, X, ChevronRight, UserCheck,
} from 'lucide-react';
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-white/10">
          {isSidebarOpen && (
            <button onClick={() => navigate(ROUTES.HOME)} className="flex items-center gap-2">
              ...
              <div>
                <span className="text-base font-bold text-white">Khen<span className="text-[#00C9A7]">X</span></span>
          ...
          <button
            ...
            className={cn('text-slate-400 hover:text-white transition-colors rounded-md p-1', !isSidebarOpen && 'mx-auto')}
          >
