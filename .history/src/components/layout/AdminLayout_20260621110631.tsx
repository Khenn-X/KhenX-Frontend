    ...
    <div className="flex min-h-screen bg-[#F8FAFC]">
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-2 space-y-1">
          {adminNavItems.map(({ label, to, icon: Icon, statKey }) => {
          ...
          {isSidebarOpen && user && (
            <div className="flex items-center gap-3 px-2 py-2 rounded-lg bg-white/5 mb-2">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-[#F59E0B]">Administrator</p>
              </div>
            </div>
          )}
          <button
          ...
          {user && (
            <div className="flex items-center gap-3">
              <div className="text-right">
                ...
                <p className="text-xs text-[#F59E0B]">{isSuperadmin ? 'Superadmin' : 'Administrator'}</p>
              </div>
