  ...
  return (
    <div className="flex min-h-screen bg-[#F8FAFC]">
      ...
      <main className={cn('flex-1 transition-all duration-300 ease-in-out', isSidebarOpen ? 'ml-60' : 'ml-16')}>
        {/* Top bar — borderless background, but with a divider line like the sidebar */}
        <div className="sticky top-0 z-30 flex h-16 items-center justify-between px-6 border-b border-slate-200/80">
