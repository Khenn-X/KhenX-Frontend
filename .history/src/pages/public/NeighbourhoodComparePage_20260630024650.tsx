...
import {
  ...
  Clock, Database, TrendingUp, CheckCircle2, XCircle,
...
const floodConfig = {
  low:    { label: 'Low Risk',    Icon: CheckCircle2, color: 'text-[#00C9A7]' },
  medium: { label: 'Medium Risk', Icon: MinusCircle,  color: 'text-amber-400' },
  high:   { label: 'High Risk',   Icon: XCircle,      color: 'text-red-400'   },
};
