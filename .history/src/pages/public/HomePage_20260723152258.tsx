...
const Hero = () => {
  ...
  return (
<section className="relative z-10 overflow-hidden min-h-[90vh] flex items-center px-4 py-16">      {/* Background */}
          ...
          <div className="text-left">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[#00C9A7] px-8 py-4 text-lg font-semibold text-[#0A1628] transition-transform hover:scale-[1.03] hover:bg-[#00E0BA] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00C9A7]"
              >
                Browse listings
