...
export const useListings = (params?: ListingsQueryParams) => {
  ...
  // Log hook state to verify query lifecycle in browser console
  // (params may be undefined when called without filters)
  console.log('useListings params:', params);
  console.log('useListings query:', { isLoading: query.isLoading, data: query.data, isError: query.isError });
