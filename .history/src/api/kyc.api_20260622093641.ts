...
export const kycApi = {
  ...
  // GET /admin/agents?kycStatus=pending — returns agents with pending KYC
  ...
  // GET /admin/agents/:id/kyc-doc-url — signed Cloudinary URLs
