...
export const listingSchema = z.object({
  ...
  bedrooms: z
    .number({ invalid_type_error: 'Please enter number of bedrooms' })
    .min(0, 'Bedrooms cannot be negative'),
  bathrooms: z
    .number({ invalid_type_error: 'Please enter number of bathrooms' })
  ...
  pricePeriod: z.enum(['yearly', 'monthly', 'nightly'], {
    required_error: 'Please select a price period',
  }),
