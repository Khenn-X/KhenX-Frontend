    ...
    >
      <Routes>
        ...
        <Route
          ...
          element={<SuperadminRoute><AdminLayout><SuperadminDashboardPage /></AdminLayout></SuperadminRoute>}
        />
        <Route
          path="/superadmin/admin-requests"
          element={<SuperadminRoute><AdminLayout><SuperadminAdminRequestsPage /></AdminLayout></SuperadminRoute>}
        />
